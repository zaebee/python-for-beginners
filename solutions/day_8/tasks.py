...
""" Question 25
    ...
    Hint: Define an instance parameter, need add it in __init__ method. 
...
class StringOperations:
    ...
    def upper_string(self, input_string):
        """ Return the square value of number"""
        return input_string.upper()

test_object = StringOperations()
print(test_object.upper_string('test'))